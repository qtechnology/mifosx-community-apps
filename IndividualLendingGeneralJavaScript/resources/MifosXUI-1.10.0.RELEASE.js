...
taskPermissionsMatrix = {
		...
		VIEWREPORTS: ["READ_REPORT"],
		ADDREPORT: ["CREATE_REPORT"],
		UPDATEREPORT: ["UPDATE_REPORT"],
		DELETEREPORT: ["DELETE_REPORT"],
		READMIXREPORT: ["READ_MIXREPORT"],
		...
		ADDGROUPNOTE: ["CREATE_GROUPNOTE"],

		VIEWNOTES: ["READ_CLIENTNOTE"],
		
		ADDLOANCHARGE: ["CREATE_LOANCHARGE"],
		ADDLOANCOLLATERAL: ["CREATE_LOANCOLLATERAL"],
		...
		MODIFYSAVINGSACCOUNTAPPLICATION: ["UPDATE_SAVINGSACCOUNT"],
		DELETESAVINGSACCOUNTAPPLICATION: ["DELETE_SAVINGSACCOUNT"],
		REJECTSAVINGSACCOUNTAPPLICATION: ["REJECT_SAVINGSACCOUNT"],
		WITHDRAWSAVINGSACCOUNTAPPLICATION: ["WITHDRAW_SAVINGSACCOUNT"],
		APPROVESAVINGSACCOUNTAPPLICATION: ["APPROVE_SAVINGSACCOUNT"],
		UDNOSAVINGSACCOUNTAPPLICATIONAPPROVAL: ["APPROVALUNDO_SAVINGSACCOUNT"],
		ACTIVATESAVINGSACCOUNT: ["ACTIVATE_SAVINGSACCOUNT"],
		DEPOSITSAVINGSACCOUNT: ["DEPOSIT_SAVINGSACCOUNT"],
		WITHDRAWALSAVINGSACCOUNT: ["WITHDRAWAL_SAVINGSACCOUNT"],
		CALCULATEINTERESTSAVINGSACCOUNT: ["CALCULATEINTEREST_SAVINGSACCOUNT"],
		POSTINTERESTSAVINGSACCOUNT: ["POSTINTEREST_SAVINGSACCOUNT"],
...
tenantNameExclusions = {
		...
		"CREOCORE": ["CHECKERMENU", "GROUPSMENU", "ACCOUNTINGMENU", "VIEWSAVINGPRODUCTS", "ADDSAVINGPRODUCT",
		             "VIEWOFFICEMONEYTXNS", "ADDOFFICEMONEYTXN", "ADDSAVINGACCOUNT", "VIEWCHARGES", "ADDCHARGE", "ADDLOANCHARGE", 
		             "ADDLOANCOLLATERAL","CLOSEASRESCHEDULEDLOAN", 
		             "ADDLOANGUARANTOR", "REMOVELOANGUARANTOR", "VIEWCONFIGURATION", "VIEWJOURNALENTRIES"],
		             
		"HEAVENSFAMILY": ["CHECKERMENU", "GROUPSMENU", "ACCOUNTINGMENU", 
		                  "VIEWSAVINGPRODUCTS", "ADDSAVINGPRODUCT", 
		                  "ADDSAVINGACCOUNT", "VIEWCHARGES", "ADDCHARGE", "ADDLOANCHARGE", "ADDLOANCOLLATERAL",
		                  "CLOSEASRESCHEDULEDLOAN", "ADDLOANGUARANTOR", "REMOVELOANGUARANTOR", "VIEWCONFIGURATION", "VIEWJOURNALENTRIES"]
	};
